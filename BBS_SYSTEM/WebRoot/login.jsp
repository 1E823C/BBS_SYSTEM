...
function check(){
	var login_username = document.getElementById("user.name");
	var login_password = document.getElementById("user.password");
					...
					<table style="font-size: 18px;" align="left">
						<tr>
							...
							<td><input type="text" name="user.username" id="uName"
								maxlength="10" onfocus="warnName()" onblur="return checkname()" />
							</td>
							<td id="namets"
