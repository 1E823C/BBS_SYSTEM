	...
	<div
		...
		<c:choose>
		    ...
		    <c:otherwise>
		        <div
				style="width: 300px;height: 30px;line-height: 30px;float: left;text-align: right;font-weight: bold;font-size: 16px;font-family: 微软雅黑/* background-color: red; */">
				<font color="#6699CC">${sessionScope.uname } </font>     <!-- 获取session中的登录用户名 -->
				[ <a href="util/user?opr=logout" 
					style="color:red" onclick="var toOut = (confirm('确认要退出本账号吗?')); return toOut">安全退出</a> ]
		        </div>
		    </c:otherwise>
		</c:choose>
		...
		<div
			...
			<a href="util/user?opr=getUInfo" onclick="return checkLogin()">个人中心</a>
		</div>
...
<div id="nav" align="center">
	<ul id="menuNav">
		...
		<li><a href="util/topic?opr=getAllPageTopics&opr2=All">帖子</a>
			<ul>
				<li><a href="util/topic?opr=getAllPageTopics&opr2=Hot" target="_top">热门帖子</a></li>
				<li><a href="util/topic?opr=getAllPageTopics&opr2=All" target="_top">最新帖子</a>
				</li>
			</ul>
		</li>
		<li><a href="util/type?opr=getAllType">版块</a>
		</li>

		<li><a onfocus="this.blur()" href="util/anno?opr=allAnno">公告</a></li>
	</ul>
</div>
<div class="search" align="left">
	<form action="util/topic?opr=search" method="post"
