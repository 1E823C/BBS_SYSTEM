	...
	<div class="background">
		...
		<div class="newToic" align="center">
			...
			<form id="newT" method="post" onsubmit="return validToipc()"
				action="util/topic?opr=modifytopic">
				<div class="titleStyle" align="left">修改帖子</div>
				<div class="newStyle">
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<th width="150px" align="center">文章标题</th>
							<td><input type="text" value="${sessionScope.mInfo.title}"  name="topic.title" id="tTitle" onkeyup="showLen(this);"
								...
								<input type="hidden" value="${sessionScope.mInfo.topic_username}" name="username" />
						   </td>
						...
						<tr>
							...
							<td width="700px"><textarea id="content"
									...
									id="container" type="text/plain">${sessionScope.mInfo.content}</script>
						...
						<tr>
							<th align="center" style="height: 50px">所属版块</th>
							<td>
								<table>
									<tr>
										<td>
										${sessionScope.mInfo.type_name }
										</td>
									</tr>
								</table></td>
						</tr>
						<tr>
							...
							<td align="left" style="height: 180px;"><input type="submit"
								value="修改帖子" class="butt" onclick="return validToipc()" /><input
